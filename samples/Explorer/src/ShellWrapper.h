...
public:
    ...
    virtual LPITEMIDLIST GetPidl() const
    {
        return m_pidl;
    }
...
public:
    ...
    virtual IContextMenu2* GetIContextMenu2()
    {
        return m_pIContextMenu2;
    }
    void Release();
...
public:
    ...
    virtual LPSHELLFOLDER GetIShellFolder()
    {
